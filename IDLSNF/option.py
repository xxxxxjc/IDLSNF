...
# Data specifications
parser.add_argument('--dir_data', type=str, default='E:\\xjc\\test\\ENLCA-master\\DataSet',
...
parser.add_argument('--data_range', type=str, default='1-2400/4980-4990',
...
parser.add_argument('--n_hashes',type=int,default=3,
...
parser.add_argument('--model', default='DLSN',
                    help='model name')
...
parser.add_argument('--ssim', action='store_true', help='evaluated by SSIM metrics')
